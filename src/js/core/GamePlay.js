...
export default class GamePlay {
            ...
            <div class="controls">
                ...
                <div class="score">
                    ...
                    <div class="score-current">
                        Ваши очки: ${Math.floor(this.score !== 'undefined' ? this.score : 0)} 
                    </div>
                    <div class="score-record">
                        Текущий рекорд: ${Math.floor(this.recordScore !== 'undefined' ? this.recordScore : 0)}
                    </div>
                </div>
            </div>
    ...
    updateRecord(score) {
        if (score > this.recordScore) {
            ...
            this.stateService.saveRecord(this.recordScore);
        }
    }
}
