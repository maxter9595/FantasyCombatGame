...
import { generateTeam } from '../utils/generators';
import setActiveCharacter from '../utils/setActiveCharacter';
...
export default class GameController {
    ...
    constructor(gamePlay, stateService) {
        ...
        this.gamePlay.stateService = stateService;
    ...
    newGame() {
        ...
        this.gamePlay.recordScore = this.stateService.loadRecord() || 0;
        this.nextLevel();
    ...
    init() {
        ...
        this.gamePlay.addLoadGameListener(() => {
            ...
            if (loadedState) {
                new GameState(this).from(loadedState);
                this.gamePlay.showModalMessage('Игра загружена');
            } else {
                this.gamePlay.showModalMessage('Нет сохраненной игры', 'error');
            }
        });
    }
            ...
            if (this.activeCharacter) {
                if (this.activeCharacter.attack.includes(index)) {
                    ...
                    this.gamePlay.showDamage(index, damage).then(() => {
                        ...
                        this.gamePlay.updateRecord(this.gamePlay.score);
